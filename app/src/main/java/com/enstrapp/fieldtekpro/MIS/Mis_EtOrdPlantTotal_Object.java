...
public class Mis_EtOrdPlantTotal_Object {
    private String mTotal_pt;
    private String mSwerk_pt;
    private String mName_pt;
    private String mAuart_pt;
    private String mAuartx_pt;
    ...
    public void setmAuart_pt(String mAuart_pt) {
        this.mAuart_pt = mAuart_pt;
    }

    public String getmAuart_pt() {
        return mAuart_pt;
    }

    public void setmAuartx_pt(String mAuartx_pt) {
        this.mAuartx_pt = mAuartx_pt;
    }

    public String getmAuartx_pt() {
        return mAuartx_pt;
    }
