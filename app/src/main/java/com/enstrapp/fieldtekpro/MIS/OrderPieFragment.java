...
public class OrderPieFragment extends Fragment {
    ...
    Button monthYear_bt;
    ListView listview;
    TextView plant_bt, wrkcntr_bt, noData_tv;
   ...
   Order_Analysis_Activity ma;
    ...
    ArrayList<Mis_EtOrdPlantTotal_Object> pt_o = new ArrayList<>();
    ArrayList<Mis_EtOrdArbplTotal_Object> art_o = new ArrayList<>();
    ArrayList<Mis_EtOrdTypeTotal_Object> tt_o = new ArrayList<>();
    ArrayList<Mis_EtOrdArbplTotal_Object> art_fo = new ArrayList<>();

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.mis_order_analysis_fragment, container,
                false);
        ...
        FieldTekPro_db = getActivity().openOrCreateDatabase(DATABASE_NAME, MODE_PRIVATE,
                null);
        ...
        try {
            ...
            Toast.makeText(getActivity(), "Error in Date Parsing", Toast.LENGTH_SHORT).show();
        }
        ...
        if (!getUserVisibleHint())
           ...
           ma.iv_filter.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    plant_bt = filter_dialog.findViewById(R.id.plant_tv);
                    wrkcntr_bt = filter_dialog.findViewById(R.id.wrkcntr_tv);
                    ...
                    if (!plantName_s.equals("")) {
                        plant_bt.setText(plantName_s);
                    }

                    if (!wrkcntrName_s.equals("")) {
                        wrkcntr_bt.setText(wrkcntrName_s);
                    }
                    ...
                    plant_bt.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            ...
                            ok_filter_button.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    if (changed_b) {
                                        ...
                                        wrkcntrT_s = "";
                                        wrkcntrNameT_s = "";
                                        plant_bt.setText(plantNameT_s);
                                        wrkcntr_bt.setText(wrkcntrNameT_s);
                                        plant_dialog.dismiss();
                                    } else {
                    ...
                    wrkcntr_bt.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                                ...
                                if (swerkT_s.equals("") || swerkT_s == null) {
                                    ...
                                    for (int i = 0; i < art_o.size(); i++) {
                                        ...
                                        if (art_o.get(i).getmSwerk_art().equals(swerk_s)) {
                                            Mis_EtOrdArbplTotal_Object art_foo =
                                                    new Mis_EtOrdArbplTotal_Object();
                                            ...
                                            art_foo.setmAuart_art(art_o.get(i).getmAuart_art());
                                            art_foo.setmAuartx_art(art_o.get(i).getmAuartx_art());
    ...
    public class FILTER_PLANT_TYPE_Adapter extends BaseAdapter {
        ...
        public FILTER_PLANT_TYPE_Adapter(Context context,
                                         List<Mis_EtOrdPlantTotal_Object> mainDataList) {
            mContext = context;
    ...
    public class WKCENTER_TYPE_ADAPTER extends BaseAdapter {
        ...
        public WKCENTER_TYPE_ADAPTER(Context context,
                                     List<Mis_EtOrdArbplTotal_Object> mainDataList) {
            mContext = context;
            this.mainDataList = mainDataList;
            inflater = LayoutInflater.from(mContext);
    ...
    public class Get_OrderAnalysis_Data_ extends AsyncTask<String, Integer, Void> {
        ...
        protected Void doInBackground(String... params) {
            try {
                ...
                OrderAnalysis_Status = OrderAnalysis.Get_OrderAnalysis_Data(getActivity(), "MISR", month, year);
            } catch (Exception e) {
            }
            return null;
        }
        ...
        protected void onPostExecute(Void result) {
            ...
            Log.v("kiran_OrderAnalysis", OrderAnalysis_Status + "...");
            {
                if (OrderAnalysis_Status.equals(("success"))) {
                    ...
                    pieChart.setCenterText("Order Analysis");
                ...
                for (int i = 0; i < art_fo.size(); i++) {
                    if (art_fo.get(i).getmSwerk_art().equals(plant) && art_fo.get(i).getmArbpl_art().equals(wrkcntr_s)) {
                        try {
                            ...
                            Log.v("Order_number_conv", "" + e.getMessage());
                            pieChart.setVisibility(View.GONE);
                            noData_tv.setVisibility(View.VISIBLE);
                            progressdialog.dismiss();
                        }
