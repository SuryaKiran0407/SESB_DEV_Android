...
public class Mis_EtPermitWa_Object {
    ...
    public String getObjtyp_txt() {
        return objtyp_txt;
    }
    public void setObjtyp_txt(String Objtyp_txt) {
        this.objtyp_txt = Objtyp_txt;
    }
