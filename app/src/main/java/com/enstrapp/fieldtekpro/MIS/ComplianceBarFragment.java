...
public class ComplianceBarFragment extends Fragment {
    ...
    ArrayList<Mis_EtNotifArbplTotal_Object> art_fo_c = new ArrayList<Mis_EtNotifArbplTotal_Object>();
    ArrayList<Mis_EtNotifTypeTotal_Object> tt_o = new ArrayList<Mis_EtNotifTypeTotal_Object>();
    ArrayList<Mis_EtNotifTypeTotal_Object> tt_so = new ArrayList<Mis_EtNotifTypeTotal_Object>();
    ArrayList<Mis_EtNotifTypeTotal_Object> filter = new ArrayList<Mis_EtNotifTypeTotal_Object>();
    ArrayList<Mis_EtNotifPlantTotal_Object> pt_o_c = new ArrayList<Mis_EtNotifPlantTotal_Object>();
    ArrayList<Mis_EtNotifArbplTotal_Object> art_o_c = new ArrayList<Mis_EtNotifArbplTotal_Object>();
                                ...
                                if (swerk_ct.equals("") || swerk_ct == null) {
                                    ...
                                    for (int i = 0; i < art_o_c.size(); i++) {
                                        if (art_o_c.get(i).getmSwerk_art().equals(swerk_c)) {
                                            ...
                                            art_foo.setmQmart_art(art_o_c.get(i).getmQmart_art());
                                            art_foo.setmQmartx_art(art_o_c.get(i).getmQmartx_art());
    ...
    public class FILTER_PLANT_TYPE_Adapter extends BaseAdapter {
        ...
        public FILTER_PLANT_TYPE_Adapter(Context context, List<Mis_EtNotifPlantTotal_Object> mainDataList) {
            mContext = context;
