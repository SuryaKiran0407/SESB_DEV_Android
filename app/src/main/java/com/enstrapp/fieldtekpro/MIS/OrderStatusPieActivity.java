...
public class OrderStatusPieActivity extends AppCompatActivity {
    ...
    ArrayList<Mis_EtOrdTypeTotal_Object> swerk_p = new ArrayList<Mis_EtOrdTypeTotal_Object>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mis_orderanalysis_type_activity);
    ...
    private void Load_Order_Reports() {

        progressdialog = new ProgressDialog(OrderStatusPieActivity.this, ProgressDialog.THEME_HOLO_LIGHT);
        ...
        if (value.equals("") && value == null) {
            ...
            if (swerk.equals("")) {
                try {
                    if (value.equals(getString(R.string.outstanding))) {
                        ...
                        for (int i = 0; i < tt_o.size(); i++) {
                            String order = tt_o.get(i).getmAuart_tt();
                            if (tt_fo.size() > 0) {
                                if (contains(tt_fo, order)) {
                                    ...
                                    tt_cf_o.setmAuartx_tt(tt_o.get(i).getmAuartx_tt());
                        ...
                        Label_Adapter ll_a = new Label_Adapter(OrderStatusPieActivity.this, llo);
                    ...
                    if (value.equals(getString(R.string.inprgs))) {
                        ...
                        for (int j = 0; j < tt_fo.size(); j++) {
                            ...
                            if (Inpr1.get(j) == 0) {
                                ...
                                entries.add(new PieEntry((float) Inpr1.get(j), tt_fo.get(j).getmAuart_tt() + "-" + tt_fo.get(j).getmAuartx_tt() + " (" + Inpr1.get(j) + ")"));
                                Label_List_Object llo_o = new Label_List_Object();
                                llo_o.setLabel(tt_fo.get(j).getmAuart_tt() + "-" + tt_fo.get(j).getmAuartx_tt() + " (" + Inpr1.get(j) + ")");
                                llo.add(llo_o);
                            }
                        }
                        final ArrayList<Integer> colors = new ArrayList<Integer>();
                    ...
                    if (value.equals(getString(R.string.compltd))) {
                        ...
                        for (int j = 0; j < tt_fo.size(); j++) {
                            ...
                            if (Comp1.get(j) == 0) {
                                ...
                                entries.add(new PieEntry((float) Comp1.get(j), tt_fo.get(j).getmAuart_tt() + "-" + tt_fo.get(j).getmAuartx_tt() + " (" + Comp1.get(j) + ")"));
                                Label_List_Object llo_o = new Label_List_Object();
                                llo_o.setLabel(tt_fo.get(j).getmAuart_tt() + "-" + tt_fo.get(j).getmAuartx_tt() + " (" + Comp1.get(j) + ")");
                                llo.add(llo_o);
                            }
                        }
                ...
                ArrayList<Mis_EtOrdTypeTotal_Object> tt_swerk = new ArrayList<Mis_EtOrdTypeTotal_Object>();
                plant_all = false;
                try {
                    ...
                    if (value.equals(getString(R.string.outstanding))) {
                        ...
                        if (wrkcnt.equals("")) {
                            for (int j = 0; j < tt_o.size(); j++) {
                                Mis_EtOrdTypeTotal_Object tt_so = new Mis_EtOrdTypeTotal_Object();
                                if (tt_o.get(j).getmSwerk_tt().equals(swerk)) {
                                    tt_so.setmOuts_tt(tt_o.get(j).getmOuts_tt());
                                    tt_so.setmAuart_tt(tt_o.get(j).getmAuart_tt());
                                    tt_so.setmAuartx_tt(tt_o.get(j).getmAuartx_tt());
                                    tt_swerk.add(tt_so);
                                    filter.add(tt_so);
                                }
                            }
                            ...
                            for (int i = 0; i < tt_swerk.size(); i++) {
                                ...
                                if (tt_fo.size() > 0) {
                                    if (contains(tt_fo, order)) {
                                        ...
                                        tt_cf_o.setmAuart_tt(order);
                                        tt_cf_o.setmAuartx_tt(tt_swerk.get(i).getmAuartx_tt());
                                        tt_cf_o.setmOuts_tt(String.valueOf(total));
                                        tt_fo.add(tt_cf_o);
                                        total = 0;
                                    }
                        ...
                        for (int k = 0; k < tt_fo.size(); k++) {
                            ...
                            if (Outs1.get(k) == 0) {
                                ...
                                entries.add(new PieEntry((float) Outs1.get(k), tt_fo.get(k).getmAuart_tt() + "-" + tt_fo.get(k).getmAuartx_tt() + " (" + Outs1.get(k) + ")"));
                                Label_List_Object llo_o = new Label_List_Object();
                                llo_o.setLabel(tt_fo.get(k).getmAuart_tt() + "-" + tt_fo.get(k).getmAuartx_tt() + " (" + Outs1.get(k) + ")");
                                llo.add(llo_o);
                            }
                        }
                        final ArrayList<Integer> colors = new ArrayList<Integer>();
                    ...
                    if (value.equals(getString(R.string.inprgs))) {
                        ...
                        for (int k = 0; k < tt_fo.size(); k++) {
                            ...
                            if (Inpr1.get(k) == 0) {
                                ...
                                entries.add(new PieEntry((float) Inpr1.get(k), tt_fo.get(k).getmAuart_tt() + "-" + tt_fo.get(k).getmAuartx_tt() + " (" + Inpr1.get(k) + ")"));
                                Label_List_Object llo_o = new Label_List_Object();
                                llo_o.setLabel(tt_fo.get(k).getmAuart_tt() + "-" + tt_fo.get(k).getmAuartx_tt() + " (" + Inpr1.get(k) + ")");
                                llo.add(llo_o);
                            }
                        }
                        final ArrayList<Integer> colors = new ArrayList<Integer>();
                    ...
                    if (value.equals(getString(R.string.compltd))) {
                        ...
                        if (wrkcnt.equals("")) {
                            ...
                            for (int j = 0; j < tt_o.size(); j++) {
                                ...
                                if (tt_o.get(j).getmSwerk_tt().equals(swerk) && tt_o.get(j).getmArbpl_tt().equals(wrkcnt)) {
                                    tt_so.setmComp_tt(tt_o.get(j).getmComp_tt());
                                    tt_so.setmAuart_tt(tt_o.get(j).getmAuart_tt());
                                    tt_so.setmAuart_tt(tt_o.get(j).getmAuartx_tt());
                                    tt_fo.add(tt_so);
                                }
                            }
                        }
                        ...
                        for (int k = 0; k < tt_fo.size(); k++) {
                            ...
                            if (Comp1.get(k) == 0) {
                                ...
                                entries.add(new PieEntry((float) Comp1.get(k), tt_fo.get(k).getmAuart_tt() + "-" + tt_fo.get(k).getmAuartx_tt() + " (" + Comp1.get(k) + ")"));
                                Label_List_Object llo_o = new Label_List_Object();
                                llo_o.setLabel(tt_fo.get(k).getmAuart_tt() + "-" + tt_fo.get(k).getmAuartx_tt() + " (" + Comp1.get(k) + ")");
                                llo.add(llo_o);
                            }
                        }
                        final ArrayList<Integer> colors = new ArrayList<Integer>();
