...
public class Operations_Parcelable implements Parcelable
{
    ...
    public Operations_Parcelable() {
    }

    protected Operations_Parcelable(Parcel in) {
    ...
    public static final Creator<Operations_Parcelable> CREATOR = new Creator<Operations_Parcelable>() {
        @Override
        public Operations_Parcelable createFromParcel(Parcel source) {
            return new Operations_Parcelable(source);
        }

        @Override
        public Operations_Parcelable[] newArray(int size) {
            return new Operations_Parcelable[size];
        }
    };
}
