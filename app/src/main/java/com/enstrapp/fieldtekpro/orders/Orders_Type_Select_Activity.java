...
public class Orders_Type_Select_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private class Get_Notification_Types extends AsyncTask<Void, Integer, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            custom_progress_dialog.show_progress_dialog(Orders_Type_Select_Activity.this,
        ...
        protected Void doInBackground(Void... params) {
            try {
                Cursor cursor = FieldTekPro_db.rawQuery("select * from GET_ORDER_TYPES",
                        null);
        ...
        protected void onPostExecute(Void result) {
            ...
            if (notification_type_list.size() > 0) {
                ...
                adapter = new NOTIFICATION_TYPE_ADAPTER(Orders_Type_Select_Activity.this,
                        notification_type_list);
                list_recycleview.setHasFixedSize(true);
                RecyclerView.LayoutManager layoutManager =
                        new LinearLayoutManager(Orders_Type_Select_Activity.this);
        ...
        public boolean onQueryTextChange(String query) {
            ...
            for (int i = 0; i < notification_type_list.size(); i++) {
                ...
                if (id.contains(query) || value.contains(query)) {
                    Notification_Type_Object nto =
                            new Notification_Type_Object(
                                    notification_type_list.get(i).getNotification_id(),
    ...
    public void onClick(View v) {
        if (v == back_imageview) {
            ...
            if (selected_array.size() > 0) {
                ...
                error_dialog.show_error_dialog(Orders_Type_Select_Activity.this,
                        getString(R.string.ordrtyp_select));
            }
        }
    }
}
