...
public class JSA_Controls_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (controls_data != null && !controls_data.equals("")) {
            Gson gson = new Gson();
            Type type = new TypeToken<List<JSA_Controls_Activity.Type_Object>>() {
            }.getType();
            ...
            if (type_list.size() > 0) {
                ...
                RecyclerView.LayoutManager layoutManager =
                        new LinearLayoutManager(JSA_Controls_Activity.this);
    ...
    private class Get_Types extends AsyncTask<Void, Integer, Void> {
        ...
        protected Void doInBackground(Void... params) {
            try {
                Cursor cursor = FieldTekPro_db.rawQuery("select * from EtEHSHazctrl where" +
    ...
    public void onClick(View v) {
        if (v == back_imageview) {
            ...
            if (arrayList.size() > 0) {
                ...
                error_dialog.show_error_dialog(JSA_Controls_Activity.this,
                        getString(R.string.jsa_cntrlatleast
                        ));
            }
        }
    }
