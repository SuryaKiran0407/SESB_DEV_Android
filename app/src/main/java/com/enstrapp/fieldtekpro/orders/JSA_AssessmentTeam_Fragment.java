        ...
        jsa_add_activity.add_fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Selected_status) {
                    ...
                    description_textview.setText(getString(R.string.jsa_assementdel));
                    ...
                    JSA_BasicInfo_Fragment basicinfo_tab =
                            (JSA_BasicInfo_Fragment) getFragmentManager()
                    ...
                    if (title != null && !title.equals("")) {
                        if (job_id != null && !job_id.equals("")) {
                            Intent intent = new Intent(getActivity(),
                                    JSA_Add_AssessmentTeam_Activity.class);
    ...
    public class Assess_Adapter extends RecyclerView.Adapter<Assess_Adapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemView = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.jsa_assessmentteam_list_data, parent, false);
