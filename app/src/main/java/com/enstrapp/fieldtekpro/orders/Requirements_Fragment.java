...
public class Requirements_Fragment extends Fragment {
    ...
    public class RequirementAdapter extends RecyclerView.Adapter<RequirementAdapter.MyViewHolder> {
        ...
        private List<OrdrWaChkReqPrcbl> requirementData_list;
                ...
                yes_cb.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (yes_cb.isChecked()) {
                            ...
                            ma.requ_al.get(getPosition).setYes_checked(true);
                            ma.requ_al.get(getPosition).setNo_checked(false);
                            ma.requ_al.get(getPosition).setValue("Y");
                            yes_cb.setChecked(true);
                            no_cb.setChecked(false);
                        } else {
                            int getPosition = (Integer) v.getTag();
                            ma.requ_al.get(getPosition).setYes_checked(false);
                            ma.requ_al.get(getPosition).setValue("");
                ...
                no_cb.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (no_cb.isChecked()) {
                            int getPosition = (Integer) v.getTag();
                            ma.requ_al.get(getPosition).setYes_checked(false);
                            ma.requ_al.get(getPosition).setNo_checked(true);
                            ma.requ_al.get(getPosition).setValue("N");
                            yes_cb.setChecked(false);
        ...
        public RequirementAdapter(Context mContext, List<OrdrWaChkReqPrcbl> work_list) {
            this.mContext = mContext;
            this.requirementData_list = work_list;
        }
        ...
        public void onBindViewHolder(final MyViewHolder holder, int position) {
            final OrdrWaChkReqPrcbl owrp = requirementData_list.get(position);
