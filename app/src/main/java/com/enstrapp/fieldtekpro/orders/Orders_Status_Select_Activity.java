...
public class Orders_Status_Select_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private class Get_Types extends AsyncTask<Void, Integer, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            custom_progress_dialog.show_progress_dialog(Orders_Status_Select_Activity.this,
        ...
        protected void onPostExecute(Void result) {
            ...
            if (type_list.size() > 0) {
                ...
                RecyclerView.LayoutManager layoutManager =
                        new LinearLayoutManager(Orders_Status_Select_Activity.this);
        ...
        public boolean onQueryTextChange(String query) {
            ...
            if (filteredList.size() > 0) {
                RecyclerView.LayoutManager layoutManager =
                        new LinearLayoutManager(Orders_Status_Select_Activity.this);
                list_recycleview.setLayoutManager(layoutManager);
                adapter = new TYPE_ADAPTER(Orders_Status_Select_Activity.this,
                        filteredList);
                list_recycleview.setAdapter(adapter);
    ...
    public void onClick(View v) {
        if (v == back_imageview) {
            ...
            if (selected_array.size() > 0) {
                ...
                error_dialog.show_error_dialog(Orders_Status_Select_Activity.this,
                        getString(R.string.atleastone_status));
            }
        }
    }
}
