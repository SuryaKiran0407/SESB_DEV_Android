...
public class Orders_Status_Select_Activity extends AppCompatActivity implements View.OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        h1.put("id", "CRTD");
        h1.put("text", "Order Created");
        arrayList.add(h1);
        HashMap<String, String> h2 = new HashMap<String, String>();
        h2.put("id", "REL");
        h2.put("text", "Order Released");
        arrayList.add(h2);
        HashMap<String, String> h3 = new HashMap<String, String>();
        h3.put("id", "CNF");
        h3.put("text", "Order Confirmed");
        arrayList.add(h3);
        HashMap<String, String> h4 = new HashMap<String, String>();
        h4.put("id", "CLSD");
        h4.put("text", "Order Closed");
        arrayList.add(h4);
    ...
    private class Get_Types extends AsyncTask<Void, Integer, Void>
    {
        ...
        {
            super.onPreExecute();
            custom_progress_dialog.show_progress_dialog(Orders_Status_Select_Activity.this,getResources().getString(R.string.loading));
            type_list.clear();
        }
        @Override
        ...
        protected void onPostExecute(Void result)
        {
            ...
            if (type_list.size() > 0)
            {
                ...
                adapter = new TYPE_ADAPTER(Orders_Status_Select_Activity.this, type_list);
                list_recycleview.setHasFixedSize(true);
                RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(Orders_Status_Select_Activity.this);
    ...
    SearchView.OnQueryTextListener listener = new SearchView.OnQueryTextListener()
    {
        ...
        public boolean onQueryTextChange(String query)
        {
            ...
            if(filteredList.size() > 0)
            {
                RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(Orders_Status_Select_Activity.this);
                list_recycleview.setLayoutManager(layoutManager);
                adapter = new TYPE_ADAPTER(Orders_Status_Select_Activity.this, filteredList);
                list_recycleview.setAdapter(adapter);
    ...
    public void onClick(View v)
    {
        if (v == back_imageview)
        {
            Orders_Status_Select_Activity.this.finish();
        }
        ...
        else if (v == submit_button)
        {
            ...
            {
                error_dialog.show_error_dialog(Orders_Status_Select_Activity.this,"Please Select Atleast One Status Type");
            }
        }
    }
