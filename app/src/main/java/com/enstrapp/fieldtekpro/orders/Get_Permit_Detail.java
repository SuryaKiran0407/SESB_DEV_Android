...
public class Get_Permit_Detail {

    private static SQLiteDatabase App_db;
    private static String DATABASE_NAME = "";

    public static ArrayList<OrdrPermitPrcbl> GetData(Activity activity, String orderUUID, String orderId, String orderStatus, String Iwerk) {
