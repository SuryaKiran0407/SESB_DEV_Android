...
public class Model_Order_Material_Custominfo
{
    @SerializedName("EtOrderComponentsFields")
    @Expose
    private List<EtOrderOperationsFields> EtOrderComponentsFields = null;


    public List<EtOrderOperationsFields> getEtOrderComponentsFields() {
        return EtOrderComponentsFields;
    }

    public void setEtOrderComponentsFields(List<EtOrderOperationsFields> etOrderComponentsFields) {
        EtOrderComponentsFields = etOrderComponentsFields;
    }
