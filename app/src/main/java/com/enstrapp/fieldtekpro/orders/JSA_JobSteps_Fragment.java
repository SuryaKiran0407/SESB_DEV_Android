...
public class JSA_JobSteps_Fragment extends Fragment
{
        ...
        jsa_add_activity.add_fab.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                if(Selected_status)
                {
                    ...
                    description_textview.setText("Do you want to delete selected Job Step ?");
                ...
                {
                    JSA_JobLocation_Fragment jobLocation_fragment = (JSA_JobLocation_Fragment)getFragmentManager().findFragmentByTag(makeFragmentName(R.id.viewpager,2));
                    ...
                    {
                        error_dialog.show_error_dialog(getActivity(),"Please Select Location");
                    }
                }
            }
        });
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        if (data != null && !data.equals(""))
        {
            if(requestCode == add_jobstep)
            {
                ...
                JobStep_List_Object olo = new JobStep_List_Object(step_no, jobstep_text, person_responsible_text, uniqueKey.toString(), false);
    ...
    public class Assess_Adapter extends RecyclerView.Adapter<Assess_Adapter.MyViewHolder>
    {
        ...
        {
            View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.jsa_jobsteps_list_data, parent, false);
    ...
    public class JobStep_List_Object
    {
        ...
        public JobStep_List_Object(String step_no, String jobstep_text, String person_responsible, String uuid, boolean isSelected)
        {
            this.step_no = step_no;
            this.jobstep_text = jobstep_text;
            this.person_responsible = person_responsible;
