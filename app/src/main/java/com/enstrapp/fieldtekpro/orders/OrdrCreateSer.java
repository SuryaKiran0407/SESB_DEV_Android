...
public class OrdrCreateSer {
    ...
    @SerializedName("ItConfirmOrderColl")
    @Expose
    private ArrayList<ItConfirmOrderColl_Ser> ItConfirmOrderColl;
    ...
    public ArrayList<ItConfirmOrderColl_Ser> getItConfirmOrderColl() {
        return ItConfirmOrderColl;
    }

    public void setItConfirmOrderColl(ArrayList<ItConfirmOrderColl_Ser> itConfirmOrderColl) {
        ItConfirmOrderColl = itConfirmOrderColl;
    }
