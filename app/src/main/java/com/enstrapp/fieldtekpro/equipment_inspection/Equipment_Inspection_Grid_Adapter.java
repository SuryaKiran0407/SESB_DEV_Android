...
public class Equipment_Inspection_Grid_Adapter extends BaseAdapter
{
    ...
    public Equipment_Inspection_Grid_Adapter(Equipment_Inspection_Activity mainActivity, String[] osNameList, int[] osImages)
    {
        result = osNameList;
