        ...
        else if(v == submit_button)
        {
            ...
            if (isInternetPresent)
            {
                ...
                if(reading_count.size() > 0 || result_count.size() > 0)
                {
                    ...
                    description_textview.setText("Do you want to submit inspection checklist data?");
                ...
                {
                    error_dialog.show_error_dialog(Equipment_StartInspection_Activity.this,"Please provide Reading or Result.");
                }
            }
            else
            {
   ...
   public class Adapter extends RecyclerView.Adapter<Adapter.MyViewHolder>
    ...
    private class Get_Token extends AsyncTask<Void, Integer, Void>
    {
        ...
        protected void onPostExecute(Void result)
        {
            ...
            {
                custom_progress_dialog.dismiss_progress_dialog();
                error_dialog.show_error_dialog(Equipment_StartInspection_Activity.this,"Unable to process Inspection Checklist. Please try again");
            }
        }
    }
