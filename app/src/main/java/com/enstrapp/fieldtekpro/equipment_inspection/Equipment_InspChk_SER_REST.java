...
public class Equipment_InspChk_SER_REST
{

    @SerializedName("ET_IMRG")
    @Expose
    private ArrayList<EtImrg> etImrg;

    public ArrayList<EtImrg> getEtImrg() {
        return etImrg;
    }

    public void setEtImrg(ArrayList<EtImrg> etImrg) {
        this.etImrg = etImrg;
    }
