...
public class EQ_MaintenancePlan_SER
{
    ...
    public class Result
    {
        @SerializedName("EtMsoh")
        @Expose
        private EtMsoh etMsoh;
        public EtMsoh getEtMsoh()
        {
            return etMsoh;
        }
        public void setEtMsoh(EtMsoh etMsoh)
        {
            this.etMsoh = etMsoh;
        }
    }
    ...
    public class EtMsoh
    {
        @SerializedName("results")
        @Expose
        private List<EtMsoh_Result> results = null;
        public List<EtMsoh_Result> getResults()
        {
            return results;
        }
        public void setResults(List<EtMsoh_Result> results)
        {
            this.results = results;
        }
    }
