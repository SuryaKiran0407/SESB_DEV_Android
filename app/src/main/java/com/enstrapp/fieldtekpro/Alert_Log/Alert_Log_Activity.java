...
public class Alert_Log_Activity extends AppCompatActivity implements View.OnClickListener {
        ...
        protected Void doInBackground(Void... params) {
            try {
                ...
                if (cursor != null && cursor.getCount() > 0) {
                    cursor.moveToNext();
                    do {
                        AlertLogList_Object clo = new AlertLogList_Object(cursor.getString(1), cursor.getString(2), cursor.getString(3), cursor.getString(4), cursor.getString(5), cursor.getString(6), cursor.getString(7), cursor.getString(8), cursor.getString(9), cursor.getString(10),cursor.getString(11));
    ...
    public class ALERTLIST_ADAPTER extends RecyclerView.Adapter<ALERTLIST_ADAPTER.MyViewHolder> {
        ...
        public class MyViewHolder extends RecyclerView.ViewHolder {
            public TextView log_uuid_textview, uuid_textview, user_textview, obj_id_textview, doc_type_textview, activity_textview, date_time_textview, status_textview,obj_text_textview, message_textview;
        ...
        public void onBindViewHolder(final MyViewHolder holder, final int position) {
            ...
            holder.message_textview.setText(nto.getSTATUS());
            ...
            holder.clear_layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    description_textview.setText(getString(R.string.del_slctdrecrd));
                ...
                public void onClick(View v) {
                    ...
                    if (isInternetPresent) {
                        ...
                        if (holder.doc_type_textview.getText().toString().equalsIgnoreCase("Notification") && holder.activity_textview.getText().toString().equalsIgnoreCase("Release")) {
                            description_textview.setText(getString(R.string.rel_slctnotif, holder.obj_id_textview.getText().toString()));
                            confirm.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    decision_dialog.dismiss();
                            ...
                            description_textview.setText(getString(R.string.postppn_slctnotif, holder.obj_id_textview.getText().toString()));
                            confirm.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    decision_dialog.dismiss();
                            ...
                            description_textview.setText(getString(R.string.compl_slctnotif, holder.obj_id_textview.getText().toString()));
                            confirm.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    decision_dialog.dismiss();
                            ...
                            description_textview.setText(getString(R.string.crea_slctnotif, holder.obj_id_textview.getText().toString()));
                            confirm.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    decision_dialog.dismiss();
                            ...
                            description_textview.setText(getString(R.string.chng_slctnotif, holder.obj_id_textview.getText().toString()));
                            confirm.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    decision_dialog.dismiss();
                            ...
                            description_textview.setText(getString(R.string.mtrlresvr_slct, holder.obj_id_textview.getText().toString()));
                            confirm.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    decision_dialog.dismiss();
                            ...
                            description_textview.setText(getString(R.string.crea_slctordr, holder.obj_id_textview.getText().toString()));
                            confirm.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    decision_dialog.dismiss();
                            ...
                            description_textview.setText(getString(R.string.chng_slctordr, holder.obj_id_textview.getText().toString()));
                            confirm.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    decision_dialog.dismiss();
                            ...
                            description_textview.setText(getString(R.string.cnf_slctordr, holder.obj_id_textview.getText().toString()));
                            confirm.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    decision_dialog.dismiss();
                            ...
                            description_textview.setText(getString(R.string.teco_slctordr, holder.obj_id_textview.getText().toString()));
                            confirm.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    decision_dialog.dismiss();
        ...
        protected void onPostExecute(Void result) {
            ...
            if (token_status.equalsIgnoreCase("success")) {
                ...
                error_dialog.show_error_dialog(Alert_Log_Activity.this,
                        getString(R.string.unble_to_process));
            }
        }
    }
        ...
        protected void onPostExecute(Void result) {
            ...
            if (notif_change_status.get("response_status") != null && !notif_change_status.get("response_status").equals("")) {
                if (notif_change_status.get("response_status").equalsIgnoreCase("Duplicate")) {
                    ...
                    addMessage("Unable to process Notification Change. Please try again.", log_uuid);
                    if (all)
                        RemoveId(log_uuid);
                    else {
                        custom_progress_dialog.dismiss_progress_dialog();
        ...
        protected void onPostExecute(Void result) {
            ...
            if (notif_create_status.get("response_status") != null && !notif_create_status.get("response_status").equals("")) {
                if (notif_create_status.get("response_status").equalsIgnoreCase("Duplicate")) {
                    ...
                    addMessage("Unable to process Notification Create. Please try again.", log_uuid);
                    if (all)
                        RemoveId(log_uuid);
                    else {
                        custom_progress_dialog.dismiss_progress_dialog();
        ...
        protected void onPostExecute(Void result) {
            ...
            if (notif_postpone_status != null && !notif_postpone_status.equals("")) {
                if (notif_postpone_status.equalsIgnoreCase("success")) {
                    ...
                    addMessage("Already Postponed", log_uuid);
                    if (all)
                        RemoveId(log_uuid);
                    else {
                        custom_progress_dialog.dismiss_progress_dialog();
                    ...
                    addMessage("Unable to process Notification Postpone. Please try again.", log_uuid);
                    if (all)
                        RemoveId(log_uuid);
                    else {
                        custom_progress_dialog.dismiss_progress_dialog();
        ...
        protected void onPostExecute(Void result) {
            ...
            if (notif_release_status != null && !notif_release_status.equals("")) {
                if (notif_release_status.get("response_status").equalsIgnoreCase("success")) {
                    ...
                    addMessage("Already Released", log_uuid);
                    if (all)
                        RemoveId(log_uuid);
                    else {
                        custom_progress_dialog.dismiss_progress_dialog();
                    ...
                    addMessage("Unable to process Notification Release. Please try again.", log_uuid);
                    if (all)
                        RemoveId(log_uuid);
                    else {
                        custom_progress_dialog.dismiss_progress_dialog();
    ...
    private class Get_DORD_Data extends AsyncTask<String, Integer, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            cv.put("STATUS", "Success");
            FieldTekPro_db.update("Alert_Log", cv, "LOG_UUID = ?", new String[]{log_uuid});
            addMessage(DORD_Status, log_uuid);
            if (all)
                RemoveId(log_uuid);
            else {
                custom_progress_dialog.dismiss_progress_dialog();
