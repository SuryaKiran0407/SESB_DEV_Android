...
public class REST_DeviceToken {
    ...
    public static String set_devicetoken_data(Activity activity)
    {
        try
        {
            ...
            modelLoginRest.setIv_tokenid(device_token);
            modelLoginRest.setIv_devicetype("A");
            modelLoginRest.setIv_appid("FTEKP");
            ...
            Call<BOM_SER> call = service.postDeviceToken(url_link, basic, modelLoginRest);
