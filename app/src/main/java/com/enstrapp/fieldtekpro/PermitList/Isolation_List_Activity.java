...
public class Isolation_List_Activity extends AppCompatActivity implements View.OnClickListener
{
    ...
    String[] tabTitle={"Tag/Tagged","Untag/Untagged"};
    int[] unreadCount = {0,0};
        ...
        if(v == filter_imageview)
        {
            ...
            filterBt.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    {
                        error_dialog.show_error_dialog(Isolation_List_Activity.this,"Please select function location or plant.");
                    }
                }
            });
            clearAll_textview.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    filter_functionlocation_id = ""; filter_plant_id = "";
    ...
    private void setupViewPager(final ViewPager viewPager)
    {
        ...
        adapter.addFragment(chatFragment,"Tag/Tagged");
        adapter.addFragment(callsFragment,"Untag/Untagged");
