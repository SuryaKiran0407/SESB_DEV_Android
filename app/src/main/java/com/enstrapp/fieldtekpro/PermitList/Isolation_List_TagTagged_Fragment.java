...
public class Isolation_List_TagTagged_Fragment extends Fragment {
    ...
    public Isolation_List_TagTagged_Fragment() {
    }
    ...
    public void refresh_tag_tagged_data(final String funcloc, final String plant) {
