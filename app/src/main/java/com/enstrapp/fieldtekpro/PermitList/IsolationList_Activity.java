...
public class IsolationList_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    String selected_orderstatus = "", selected_Iwerk = "", selected_orderID = "", selected_orderUUID = "",
            woco = "", permit_type = "", permit_no = "", wcnr_no = "", refObj = "";
    SearchView search;
            ...
            for (int i = 0; i < permit_list.size(); i++) {
                ...
                if (ordNo.contains(query) || permitNo.contains(query) || permitTxt.contains(query) || authGrp.contains(query)
                    ...
                    PermitList_Object nto = new PermitList_Object(permit_list.get(i).getOrder_num(), permit_list.get(i).getPmsog(),
                            ...
                            permit_list.get(i).getWcnr(), permit_list.get(i).getRefobj(),
                            permit_list.get(i).getTagged(), permit_list.get(i).getUntagged());
                    filteredList.add(nto);
                }
            }

            if (filteredList.size() > 0) {
                adapter = new PERMITLIST_ADAPTER(IsolationList_Activity.this, filteredList);
                RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(IsolationList_Activity.this);
    ...
    private class Get_Permit_List_Data extends AsyncTask<Void, Integer, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            customProgressDialog.show_progress_dialog(IsolationList_Activity.this, getResources().getString(R.string.loading));
            permit_list.clear();
        }
                        ...
                        if (cursor.moveToFirst()) {
                            do {
                                ...
                                if (list.contains(EtWcmWcagns_Pmsog)) {
                                    ...
                                    if (objnr != null && !objnr.equals("")) {
                                        try {
                                            Cursor cursor3 = FieldTekPro_db.rawQuery("select * from EtWcmWdItemData where Wcnr = ?", new String[]{wcnr});
                                            if (cursor3 != null && cursor3.getCount() > 0) {
                                                if (cursor3.moveToFirst()) {
                                                    do {
                                                        if (cursor3.getString(34).equals("X"))
                                                            ...
                                                            untagged = "UNTAGGED";
                                                        else if (cursor3.getString(36).equals("X"))
                                                            untagged = "UNTAGGED";
        ...
        protected void onPostExecute(Void result) {
            ...
            if (permit_list.size() > 0) {
                adapter = new PERMITLIST_ADAPTER(IsolationList_Activity.this, permit_list);
    ...
    public class PermitList_Object {
        ...
        public PermitList_Object(String Order_num, String Pmsog, String Gntxt, String Genvname, String Crname, String Objnr, String date_time, String werk, String counter, String Hilvl, boolean Geniakt_status, String permit_number, String floc_number, String permit_text, String auth_grp, String permit_typ, String wcnr, String refobj, String tagged, String untagged) {
    ...
    public void onClick(View v) {
        if (v == back_imageview) {
            IsolationList_Activity.this.finish();
        } else if (v == cancel_button) {
            IsolationList_Activity.this.finish();
        } else if (v == submit_button) {
            cd = new ConnectionDetector(IsolationList_Activity.this);
            isInternetPresent = cd.isConnectingToInternet();
            if (isInternetPresent) {
                submit_decision_dialog = new Dialog(IsolationList_Activity.this);
                ...
                network_connection_dialog.show_network_connection_dialog(IsolationList_Activity.this);
            }
        }
    }
                ...
                permit_issued_checkbox.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (permit_issued_checkbox.isChecked()) {
                            ...
                            permit_list.get(position).setGenvname(Crname.getText().toString());
    ...
    private class Get_Token extends AsyncTask<Void, Integer, Void> {
        ...
        protected Void doInBackground(Void... params) {
            try {
                token_status = Token.Get_Token(IsolationList_Activity.this);
            } catch (Exception e) {
            }
            return null;
        }
    ...
    private class Post_Permit_List_Data extends AsyncTask<String, Integer, Void> {
        ...
        protected Void doInBackground(String... params) {
            try {
                ...
                response_status = Permit_Isolation.Post_Data(IsolationList_Activity.this, ArrayList, abc);
            } catch (Exception e) {
            }
            return null;
        }
        ...
        protected void onPostExecute(Void result) {
            ...
            if (response_status.startsWith("S")) {
                success_dialog.show_success_dialog(IsolationList_Activity.this, response_status.substring(1));
    ...
    private class Get_Order_Data extends AsyncTask<Void, Integer, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            customProgressDialog.show_progress_dialog(IsolationList_Activity.this, getResources().getString(R.string.get_order_data));
        }

        @Override
        protected Void doInBackground(Void... voids) {
            ohp = GetOrderDetail.GetData(IsolationList_Activity.this, selected_orderUUID,
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            customProgressDialog.dismiss_progress_dialog();
            if (ohp != null) {
                Intent ordrIntent = new Intent(IsolationList_Activity.this, Orders_Change_Activity.class);
    ...
    private class Get_Permit_Data extends AsyncTask<Void, Integer, Void> {
        ...
        @Override
        protected Void doInBackground(Void... voids) {
            ww_al = Get_Permit_Detail.GetData(IsolationList_Activity.this, selected_orderUUID,
                    selected_orderID, selected_orderstatus, selected_Iwerk);
            return null;
        }
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            customProgressDialog.dismiss_progress_dialog();
            if (ww_al != null) {
                Intent ordrIntent = new Intent(IsolationList_Activity.this, Permits_Add_Update_Activity.class);
    ...
    private class Get_Isolation_Data extends AsyncTask<Void, Integer, Void> {
        ...
        @Override
        protected Void doInBackground(Void... voids) {
            wd_al = Get_Isolation_Detail.GetData(IsolationList_Activity.this,
                    selected_orderID, refObj, selected_Iwerk);
            return null;
        }
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            customProgressDialog.dismiss_progress_dialog();
            if (wd_al != null) {
                Intent ordrIntent = new Intent(IsolationList_Activity.this, Isolation_Add_Update_Activity.class);
                ordrIntent.putExtra("order", selected_orderID);
    ...
    private String getApplName(String objtyp, String iwerk) {
        Cursor cursor = null;
        try {
            cursor = FieldTekPro_db.rawQuery("select * from EtWcmTypes where Iwerk = ? and Objtyp = ?", new String[]{iwerk, objtyp});
            if (cursor != null && cursor.getCount() > 0) {
                if (cursor.moveToFirst()) {
