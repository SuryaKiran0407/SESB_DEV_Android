...
public class Notifications_CauseCode_Add_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    LinearLayout causecode_layout, cause_layout, eventcode_layout, event_layout,
            objectpart_code_layout, objpart_layout;
    EditText causedescription_edittext, causecode_edittext, cause_edittext,
            eventdescription_edittext, eventcode_edittext, event_edittext, objectpart_code_edittext,
            objpart_edittext;
    ...
    int cause_custom_info = 8, object_custom_info = 7, causecode_type = 6, cause_type = 5,
                            ...
                            if (cause_id != null && !cause_id.equals("")) {
                                if (causecode_id != null && !causecode_id.equals("")) {
                                    ...
                                    error_dialog.show_error_dialog(Notifications_CauseCode_Add_Activity.this,
                                            getString(R.string.notifcause_selectcausecode));
                                }
                            } else {
                                error_dialog.show_error_dialog(Notifications_CauseCode_Add_Activity.this,
