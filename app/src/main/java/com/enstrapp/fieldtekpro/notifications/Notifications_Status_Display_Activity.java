...
public class Notifications_Status_Display_Activity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        App_db = Notifications_Status_Display_Activity.this.openOrCreateDatabase(DATABASE_NAME, MODE_PRIVATE, null);
    ...
    private class Get_Status_Data extends AsyncTask<Void, Integer, Void>
    {
        ...
        {
            super.onPreExecute();
            progressDialog.show_progress_dialog(Notifications_Status_Display_Activity.this, getResources().getString(R.string.loading));
        }
        @Override
        protected Void doInBackground(Void... params)
        {
            try
            {
                Cursor cursor = App_db.rawQuery("select * from EtNotifStatus where Qmnum = ?", new String[]{notification_id});
                if (cursor != null && cursor.getCount() > 0)
                {
                    if (cursor.moveToFirst())
                    {
                        do
                        {
                            ...
                            {
                                Status_Object olo = new Status_Object(cursor.getString(11), cursor.getString(12), cursor.getString(13), cursor.getString(14));
                                status_list.add(olo);
                            }
                        }
        ...
        protected void onPostExecute(Void result)
        {
            ...
            {
                status_adapter = new Status_Adapter(Notifications_Status_Display_Activity.this, status_list);
                recyclerview.setHasFixedSize(true);
                RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(Notifications_Status_Display_Activity.this);
    ...
    public class Status_Adapter extends RecyclerView.Adapter<Status_Adapter.MyViewHolder>
    {
        ...
        {
            View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.status_list_data, parent, false);
