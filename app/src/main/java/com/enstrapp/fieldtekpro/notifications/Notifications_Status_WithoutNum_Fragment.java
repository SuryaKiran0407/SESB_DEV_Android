                ...
                public void onClick(View v) {
                    if (holder.status_checkbox.isChecked()) {
                        ...
                        for (int i = 0; i < list_data.size(); i++) {
                            if (list_data.get(i).getTxt04().equalsIgnoreCase("NODF") &&
                                    list_data.get(i).getAct_Status()
                                            .equalsIgnoreCase("true")) {
                                isNodf = true;
                            }
                        }
                        if (isNodf == true) {
                            if (holder.txt04_textview.getText().toString()
                                    .equalsIgnoreCase("MJCO")) {
                                if (causecode_status.equalsIgnoreCase("true")) {
                                    if (malfunc_enddate_status.equalsIgnoreCase("true")) {
                                        ...
                                        error_dialog.show_error_dialog(getActivity(),
                                                getString(R.string.entermalfuncdt_time));
                                    }
                                } else {
                                    holder.status_checkbox.setChecked(false);
                                    error_dialog.show_error_dialog(getActivity(),
                                            getString(R.string.objectpart_code));
                                }
                            } else {
                                holder.status_checkbox.setChecked(false);
                                error_dialog.show_error_dialog(getActivity(),
                                        getString(R.string.rmv_usrstatus_nodf));
                            }
                        } else {
                            if (holder.txt04_textview.getText().toString()
                                    .equalsIgnoreCase("MJCO")) {
