...
public class Model_Notif_Create
{
    @SerializedName("IvUser")
    @Expose
    ...
    @SerializedName("ItNotifHeader")
    @Expose
    private ArrayList<Model_Notif_Header> ItNotifHeader;
    ...
    public ArrayList<Model_Notif_Header> getItNotifHeader() {
        return ItNotifHeader;
    }

    public void setItNotifHeader(ArrayList<Model_Notif_Header> itNotifHeader) {
