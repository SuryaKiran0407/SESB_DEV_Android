    ...
    private class Get_Types extends AsyncTask<Void, Integer, Void> {
        ...
        protected void onPreExecute() {
            ...
            custom_progress_dialog
                    .show_progress_dialog(Notifications_Status_Select_Activity.this,
        ...
        protected void onPostExecute(Void result) {
            ...
            if (type_list.size() > 0) {
                ...
                adapter = new TYPE_ADAPTER(Notifications_Status_Select_Activity.this,
                        type_list);
                list_recycleview.setHasFixedSize(true);
                RecyclerView.LayoutManager layoutManager =
                        new LinearLayoutManager(Notifications_Status_Select_Activity.this);
    ...
    public void onClick(View v) {
        if (v == back_imageview) {
            ...
            if (selected_array.size() > 0) {
                ...
                error_dialog.show_error_dialog(Notifications_Status_Select_Activity.this,
