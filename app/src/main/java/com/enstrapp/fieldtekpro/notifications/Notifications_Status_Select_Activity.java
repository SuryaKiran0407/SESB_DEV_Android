...
public class Notifications_Status_Select_Activity extends AppCompatActivity implements View.OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        h1.put("id", "OSNO");
        h1.put("text", "Outstanding Notification");
        arrayList.add(h1);
        HashMap<String, String> h2 = new HashMap<String, String>();
        h2.put("id", "NOPR");
        h2.put("text", "Notification InProgress");
        arrayList.add(h2);
        HashMap<String, String> h3 = new HashMap<String, String>();
        h3.put("id", "NOPO");
        h3.put("text", "Notification Postpone");
        arrayList.add(h3);
        HashMap<String, String> h4 = new HashMap<String, String>();
        h4.put("id", "NOCO");
        h4.put("text", "Notification Complete");
        arrayList.add(h4);
    ...
    private class Get_Types extends AsyncTask<Void, Integer, Void>
    {
        ...
        {
            super.onPreExecute();
            custom_progress_dialog.show_progress_dialog(Notifications_Status_Select_Activity.this,getResources().getString(R.string.loading));
            type_list.clear();
        }
        @Override
        protected Void doInBackground(Void... params)
        {
            try
            {
                ...
                {
                    String id = arrayList.get(i).get("id");
                    String text = arrayList.get(i).get("text");
                    if(filt_array.contains(id))
                    {
                        Type_Object nto = new Type_Object(id, text, true);
                        type_list.add(nto);
                    }
                    else
                    {
                        Type_Object nto = new Type_Object(id, text, false);
                        type_list.add(nto);
                    }
                }
            }
        ...
        protected void onPostExecute(Void result)
        {
            ...
            if (type_list.size() > 0)
            {
                ...
                adapter = new TYPE_ADAPTER(Notifications_Status_Select_Activity.this, type_list);
                list_recycleview.setHasFixedSize(true);
                RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(Notifications_Status_Select_Activity.this);
    ...
    SearchView.OnQueryTextListener listener = new SearchView.OnQueryTextListener()
    {
        ...
        public boolean onQueryTextChange(String query)
        {
            ...
            for (int i = 0; i < type_list.size(); i++)
            {
                ...
                {
                    Type_Object nto = new Type_Object(type_list.get(i).getId().toString(), type_list.get(i).getText().toString(), type_list.get(i).isChecked_status());
            ...
            if(filteredList.size() > 0)
            {
                RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(Notifications_Status_Select_Activity.this);
                list_recycleview.setLayoutManager(layoutManager);
                adapter = new TYPE_ADAPTER(Notifications_Status_Select_Activity.this, filteredList);
                list_recycleview.setAdapter(adapter);
    ...
    public class TYPE_ADAPTER extends RecyclerView.Adapter<TYPE_ADAPTER.MyViewHolder>
    {
        ...
        public void onBindViewHolder(final TYPE_ADAPTER.MyViewHolder holder, final int position)
        {
            ...
            holder.checkbox.setChecked((type_details_list.get(position).isChecked_status() == true ? true : false));
        }
        @Override
    ...
    public void onClick(View v)
    {
        if (v == back_imageview)
        {
            Notifications_Status_Select_Activity.this.finish();
        }
        ...
        else if (v == submit_button)
        {
            ...
            {
                error_dialog.show_error_dialog(Notifications_Status_Select_Activity.this,"Please Select Atleast One Status Type");
            }
        }
    }
