...
public class Notifications_View_Attachements_Activity extends AppCompatActivity
{
    ...
    {
        custom_progress_dialog.show_progress_dialog(Notifications_View_Attachements_Activity.this,"Downloading...");
    ...
    private class GetAttachmentUri extends AsyncTask<String, Integer, Void>
    {
        ...
        protected Void doInBackground(String... params)
        {
            try
            {
                ...
                Notif_Attatchment_status = GetAttachmenturi.DocTypeUri(Notifications_View_Attachements_Activity.this, DocId, object_type);
            }
            catch (Exception e)
            {
            }
        ...
        protected void onPostExecute(final Void result)
        {
            ...
            if (Notif_Attatchment_status.get("response_status") != null && !Notif_Attatchment_status.get("response_status").equals(""))
            {
                if (Notif_Attatchment_status.get("response_status").equalsIgnoreCase("Success"))
                {
                    try
                    {
                ...
                {
                    custom_progress_dialog.dismiss_progress_dialog();
                    error_dialog.show_error_dialog(Notifications_View_Attachements_Activity.this,"Error while downloading the file. Please try again.");
                }
            }
            else
            {
