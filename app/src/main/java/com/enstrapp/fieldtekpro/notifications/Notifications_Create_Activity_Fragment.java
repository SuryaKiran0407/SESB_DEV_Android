...
public class Notifications_Create_Activity_Fragment extends Fragment {
            ...
            public void onClick(View v) {
                if (isSelected) {
                    ...
                    Notifications_Create_Causecode_Fragment causecode_fragment =
                            (Notifications_Create_Causecode_Fragment) getFragmentManager()
            ...
            try {
                if (selected_pos != null && !selected_pos.equals("")) {
                    Activity_Object to = new Activity_Object(cause_itemkey, cause_text, item_key,
                            objectpartcode_id, event_id, codegroup_id, codegroup_text,
                            code_id, code_text, shttext, start_date_formatted, start_time_formatted,
                    ...
                    Activity_Object to = new Activity_Object(cause_itemkey, cause_text, item_key,
                            ...
                            code_text, shttext, start_date_formatted, start_time_formatted,
                            end_date_formatted, end_time_formatted,
                            selected_activity_custom_info_arraylist, false);
    ...
    public class Activity_Object {
        ...
        public Activity_Object(String cause_itemkey, String cause_shtxt, String activity_itemkey,
                               ...
                               String activity_shtxt, String st_date, String st_time,
    ...
    public class ACTIVITY_ADAPTER extends RecyclerView.Adapter<ACTIVITY_ADAPTER.MyViewHolder> {
        ...
        public class MyViewHolder extends RecyclerView.ViewHolder {
            public TextView st_date, code_textview, activity_key_textview, activity_text_textview,
                    code_group_textview;
            ...
            public MyViewHolder(View view) {
                super(view);
                activity_key_textview = view.findViewById(R.id.activity_key_textview);
                activity_text_textview = view.findViewById(R.id.activity_text_textview);
                code_group_textview = view.findViewById(R.id.code_group_textview);
                code_textview = view.findViewById(R.id.code_textview);
