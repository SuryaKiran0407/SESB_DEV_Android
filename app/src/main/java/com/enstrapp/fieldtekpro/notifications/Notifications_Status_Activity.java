...
public class Notifications_Status_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            status_systemstatus_array = extras
                    .getParcelableArrayList("status_systemstatus_array");
    ...
    public void onClick(View v) {
        if (v == cancel_button) {
            ...
            Notifications_Status_WithNum_Fragment withnum_tab =
                    (Notifications_Status_WithNum_Fragment) getSupportFragmentManager()
            ...
            Notifications_Status_WithoutNum_Fragment withoutnum_tab =
                    (Notifications_Status_WithoutNum_Fragment) getSupportFragmentManager()
                            .findFragmentByTag(makeFragmentName(R.id.viewpager, 2));
            ArrayList<Notif_Status_WithNum_Prcbl> withoutnum_list =
                    withoutnum_tab.getstatus_withoutNumData();
            Notifications_Status_System_Fragment systemstatus_tab =
                    (Notifications_Status_System_Fragment) getSupportFragmentManager()
                            .findFragmentByTag(makeFragmentName(R.id.viewpager, 0));
            ArrayList<Notif_Status_WithNum_Prcbl> systemstatus_list = systemstatus_tab
                    .getstatus_systemstatusData();
