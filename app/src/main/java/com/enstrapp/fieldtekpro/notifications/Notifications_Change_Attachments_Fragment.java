...
public class Notifications_Change_Attachments_Fragment extends Fragment {
    ...
    public Notifications_Change_Attachments_Fragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (bundle != null)
        {
            ...
            etdocs_parcablearray = nhp.getEtDocsParcelables();
        ...
        try {
            EtDocs_cursor = App_db.rawQuery("select * from DUE_NOTIFICATION_EtDocs " +"where Zobjid = ?", new String[]{nca.qmnum});
