...
public class Notifications_Type_Select_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private class Get_Notification_Types extends AsyncTask<Void, Integer, Void> {
        ...
        protected void onPreExecute() {
            ...
            custom_progress_dialog
                    .show_progress_dialog(Notifications_Type_Select_Activity.this,
                            getResources().getString(R.string.loading_notif_types));
        ...
        protected Void doInBackground(Void... params) {
            try {
                Cursor cursor = FieldTekPro_db.rawQuery("select * from GET_NOTIFICATION_TYPES",
                        null);
        ...
        protected void onPostExecute(Void result) {
            ...
            if (notification_type_list.size() > 0) {
                ...
                adapter =
                        new NOTIFICATION_TYPE_ADAPTER(Notifications_Type_Select_Activity.this,
                                notification_type_list);
                list_recycleview.setHasFixedSize(true);
                RecyclerView.LayoutManager layoutManager =
                        new LinearLayoutManager(Notifications_Type_Select_Activity.this);
    ...
    public void onClick(View v) {
        if (v == back_imageview) {
            Notifications_Type_Select_Activity.this.finish();
            ...
            if (selected_array.size() > 0) {
                ...
                error_dialog.show_error_dialog(Notifications_Type_Select_Activity.this,
                        getString(R.string.select_notiftype));
            }
        }
    }
}
