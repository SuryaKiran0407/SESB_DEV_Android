...
import com.enstrapp.fieldtekpro.InitialLoad_Rest.REST_Notifications;
...
public class Notifications_List_Activity extends AppCompatActivity implements View.OnClickListener
{
    ...
    String username = "", person_responsible_id = "", pers_resp_status = "", sort_selected = "",DORD_Status = "", scan_clicked_equip = "", attachment_clicked_status = "",filt_selected_wckt_ids = "", filt_wckt_text = "", filt_maintplant_ids = "", filt_wckt_ids = "",filt_selected_status_ids = "", filt_status_ids = "", filt_selected_prior_ids = "",filt_priority_ids = "", filt_selected_maintplant_ids = "", filt_selected_notif_ids = "", filt_notification_ids = "",notif_postpone_status = "", notif_complete_status = "", DNOT_Status = "";
    Dialog decision_dialog;
    LinearLayout no_data_layout;
    Success_Dialog success_dialog = new Success_Dialog();
    int fil_maintplant_type = 5, fil_notif_type = 0, fil_prior_type = 1, fil_status_type = 2, fil_wckt_type = 3,scan_status = 4;
    Button filt_notif_type_button, filt_priority_type_button, filt_status_type_button,maintenance_plant_button, filt_workcenter_type_button;
                ...
                if (cursor != null && cursor.getCount() > 0)
                {
                    if (cursor.moveToFirst())
                    {
                        do
                        {
                            ...
                            String startdate_time = cursor.getString(18) + " " +cursor.getString(51);
    ...
    public class Notif_Adapter extends RecyclerView.Adapter<Notif_Adapter.MyViewHolder>
    {
        ...
        public void onBindViewHolder(final MyViewHolder holder, int position)
        {
            ...
            if (holder.priority_textview.getText().toString().contains("Critical"))
            {
                ...
                holder.priority_textview.setBackground(getResources().getDrawable(R.drawable.critical_round));
            }
            else if (holder.priority_textview.getText().toString().contains("Very"))
            {
                holder.priority_textview.setVisibility(View.VISIBLE);
                holder.priority_textview.setBackground(getResources().getDrawable(R.drawable.vhigh_round));
            }
            else if (holder.priority_textview.getText().toString().contains("High"))
            {
                holder.priority_textview.setVisibility(View.VISIBLE);
                holder.priority_textview.setBackground(getResources().getDrawable(R.drawable.high_round));
            }
            ...
            {
                holder.priority_textview.setVisibility(View.VISIBLE);
                holder.priority_textview.setBackground(getResources().getDrawable(R.drawable.low_round));
            }
            else
            {
            ...
            if (olo.getdocs_status().equalsIgnoreCase("true"))
            {
            ...
            holder.teco_layout.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    String notif_id = olo.getNotifType();
                    if(notif_id.equalsIgnoreCase("T2") || notif_id.equalsIgnoreCase("T1") || notif_id.equalsIgnoreCase("D1") || notif_id.equalsIgnoreCase("D2"))
                    {
                        String mal_dat_tim_status = "false";
                        try
                        {
                            Cursor cursor = App_db.rawQuery("select * from " +"DUE_NOTIFICATION_NotifHeader where Qmnum = ?",new String[]{holder.id_textview.getText().toString()});
                            if (cursor != null && cursor.getCount() > 0)
                            {
                                if(cursor.moveToFirst())
                                {
                            ...
                            if (isInternetPresent)
                            {
                                ...
                                confirm.setOnClickListener(new View.OnClickListener()
                                {
                                    ...
                                    public void onClick(View v)
                                    {
                                        ...
                                        {
                                            new Post_Notification_Complete_REST().execute(notif_number);
                                        }
                                    }
                                });
                                decision_dialog.show();
                        ...
                        {
                            error_dialog.show_error_dialog(Notifications_List_Activity.this,getString(R.string.notifmalfendmandate));
                        }
                    }
                    else
                    {
                        ...
                        try
                        {
                            Cursor cursor = App_db.rawQuery("select * from " +"DUE_NOTIFICATIONS_EtNotifItems where Qmnum = ?",new String[]{holder.id_textview.getText().toString()});
                            if (cursor != null && cursor.getCount() > 0)
                            {
                        ...
                        {
                            error_dialog.show_error_dialog(Notifications_List_Activity.this,getString(R.string.notifobjdmg_mandate));
                        }
                    }
                }
            });
                    ...
                    if (isInternetPresent)
                    {
                        ...
                        confirm.setOnClickListener(new View.OnClickListener()
                        {
                            ...
                            public void onClick(View v)
                            {
                                ...
                                {
                                    new Post_Notification_Release_REST().execute(notif_number);
                                }
                            }
                        });
                        decision_dialog.show();
                    ...
                    if (isInternetPresent)
                    {
                        ...
                        confirm.setOnClickListener(new View.OnClickListener()
                        {
                            ...
                            public void onClick(View v)
                            {
                                ...
                                {
                                    new Post_Notification_Postpone_REST().execute(notif_number);
                                }
                            }
                        });
                        decision_dialog.show();
    ...
    public void onClick(View v)
    {
        ...
        else if (v == filter_fab_button)
        {
            ...
            maintenance_plant_button.setOnClickListener(new View.OnClickListener()
            {
                ...
                {
                    Intent notification_type_intent = new Intent(Notifications_List_Activity.this,Notifications_MaintPlant_Activity.class);
            ...
            filterBt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if ((filt_notification_ids != null && !filt_notification_ids.equals("")) ||
                        ...
                        filt_selected_maintplant_ids = filt_maintplant_ids.trim();
                        if (filt_selected_maintplant_ids.contains(","))
                        {
                            filt_selected_maintplant_ids = filt_selected_maintplant_ids.replace(",", "|");
                            filt_selected_maintplant_ids = filt_selected_maintplant_ids.substring(0, filt_selected_maintplant_ids.length() - 1);
                        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (data != null && !data.equals("")) {
            if (requestCode == fil_maintplant_type) {
                filt_maintplant_ids = data.getStringExtra("maintplant_ids");
                maintenance_plant_button.setText(filt_maintplant_ids);
            }
            else if (requestCode == fil_notif_type) {
    ...
    public class Get_Notifications_Refresh_Data extends AsyncTask<Void, Integer, Void> {
        ...
        protected Void doInBackground(Void... params) {
            try
            {
                ...
                {
                    DNOT_Status = REST_Notifications.Get_DNOT_Data(Notifications_List_Activity.this,"REFR", "");
                }
            }
            catch (Exception e)
            {
    ...
    /*Posting Notification Release REST to Backend Server*/
    private class Post_Notification_Release_REST extends AsyncTask<String, Integer, Void> {
        String notification_id = "";
        ...
        protected Void doInBackground(String... params) {
            try {
                notification_id = params[0];
                notif_release_status = Notification_Release_REST
                        .Get_Notif_Release_Data(Notifications_List_Activity.this, params[0]);
            } catch (Exception e) {
            }
            return null;
        ...
        protected void onPostExecute(Void result)
        {
            ...
            if (notif_release_status != null && !notif_release_status.equals(""))
            {
                ...
                else if(notif_release_status.get("response_status").startsWith("Error"))
                {
                    progressDialog.dismiss_progress_dialog();
                    error_dialog.show_error_dialog(Notifications_List_Activity.this,notif_release_status.get("response_data").substring(1));
                }
                else
                {
                    progressDialog.dismiss_progress_dialog();
    ...
    /*Posting Notification Postpone REST to Backend Server*/
    private class Post_Notification_Postpone_REST extends AsyncTask<String, Integer, Void> {
        String notification_id = "";
        ...
        protected Void doInBackground(String... params) {
            try {
                notification_id = params[0];
                notif_postpone_status = Notification_Postpone_REST
                        .Get_Notif_Postpone_Data(Notifications_List_Activity.this, params[0]);
            } catch (Exception e) {
            }
            return null;
    ...
    /*Posting Notification Complete to Backend Server*/
    private class Post_Notification_Complete_REST extends AsyncTask<String, Integer, Void> {
        String notification_id = "";
        @Override
        protected void onPreExecute() {
            super.onPreExecute();
        ...
        protected Void doInBackground(String... params) {
            ...
            {
                notification_id = params[0];
                notif_complete_status = Notification_Complete_REST.Get_NOCO_Data(Notifications_List_Activity.this, params[0]);
            }
            catch (Exception e)
            {
            }
        ...
        protected void onPostExecute(Void result) {
            ...
            if (notif_complete_status != null && !notif_complete_status.equals(""))
            {
                if (notif_complete_status.startsWith("S"))
                {
                    ContentValues cv = new ContentValues();
                    cv.put("Xstatus", "NOCO");
                    cv.put("STATUS", "NOCO");
                    ...
                    progressDialog.dismiss_progress_dialog();
                    success_dialog.show_success_dialog(Notifications_List_Activity.this,notif_complete_status.substring(1));
                    new Get_Notifications_List_Data().execute();
                }
                else if (notif_complete_status.startsWith("E"))
                {
            ...
            {
                progressDialog.dismiss_progress_dialog();
                error_dialog.show_error_dialog(Notifications_List_Activity.this,getString(R.string.notifcomplete_fail));
            }
        }
    }
    /*Posting Notification Complete to Backend Server*/
                    ...
                    if (EtDocs_cursor != null && EtDocs_cursor.getCount() > 0) {
                        if (EtDocs_cursor.moveToFirst()) {
                            do {
                                ...
                                //nap.setContentX(EtDocs_cursor.getString(8));
