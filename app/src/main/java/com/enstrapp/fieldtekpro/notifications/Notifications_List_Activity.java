...
public class Notifications_List_Activity extends AppCompatActivity implements View.OnClickListener
{
    ...
    FloatingActionButton create_fab_button, filter_fab_button, refresh_fab_button, scan_fab_button, sort_fab_button;
    ...
    String username = "", person_responsible_id = "", pers_resp_status = "", sort_selected = "", DORD_Status = "", scan_clicked_equip = "", attachment_clicked_status = "", filt_selected_wckt_ids = "", filt_wckt_text = "", filt_wckt_ids = "", filt_selected_status_ids = "", filt_status_ids = "", filt_selected_prior_ids = "", filt_priority_ids = "", filt_selected_notif_ids = "", filt_notification_ids = "", notif_postpone_status = "", notif_complete_status = "", DNOT_Status = "";
    Dialog decision_dialog;
    LinearLayout no_data_layout;
    Success_Dialog success_dialog = new Success_Dialog();
    int fil_notif_type = 0, fil_prior_type = 1, fil_status_type = 2, fil_wckt_type = 3, scan_status = 4;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        App_db = Notifications_List_Activity.this.openOrCreateDatabase(DATABASE_NAME, MODE_PRIVATE,null);
        ...
        FieldTekPro_SharedPref = Notifications_List_Activity.this.getSharedPreferences("FieldTekPro_SharedPreferences", MODE_PRIVATE);
        ...
        String auth_create_status = Authorizations.Get_Authorizations_Data(Notifications_List_Activity.this,"Q","I");
    ...
    private class Get_Notifications_List_Data extends AsyncTask<Void, Integer, Void>
    {
        ...
        protected void onPreExecute()
        {
            ...
            progressDialog.show_progress_dialog(Notifications_List_Activity.this,getResources().getString(R.string.fetching_notifications));
        }
        @Override
        protected Void doInBackground(Void... params)
        {
            try
            {
                ...
                String auth_noco_status = Authorizations.Get_Authorizations_Data(Notifications_List_Activity.this,"Q","S");
                ...
                String auth_rel_status = Authorizations.Get_Authorizations_Data(Notifications_List_Activity.this,"Q","R");
                ...
                String auth_nopo_status = Authorizations.Get_Authorizations_Data(Notifications_List_Activity.this,"Q","PP");
                ...
                Cursor cursor = App_db.rawQuery("select * from DUE_NOTIFICATION_NotifHeader", null);
                if (cursor != null && cursor.getCount() > 0)
                {
                    if (cursor.moveToFirst())
                    {
                        do
                        {
                            ...
                            String startdate_time = cursor.getString(9)+" "+cursor.getString(11);
                            ...
                            Notif_List_Object olo = new Notif_List_Object(cursor.getString(1), cursor.getString(3), cursor.getString(4), cursor.getString(14), cursor.getString(31), startdate, cursor.getString(44), cursor.getString(21), StartDate_format, cursor.getString(17), startdate_time, cursor.getString(45), cursor.getString(2), cursor.getString(16), cursor.getString(6), teco_status, rel_status , nopo_status);
        ...
        protected void onPostExecute(Void result)
        {
            ...
            if(notifications_list.size() > 0)
            {
                ...
                notif_adapter = new Notif_Adapter(Notifications_List_Activity.this, notifications_list);
    ...
    public class Notif_List_Object
    {
        ...
        public Notif_List_Object(String UUID, String notif_id, String short_text, String priority_id, String priority_text, String startdate, String status, String docs_status, String startdate_format, String plant, String startdate_time, String ParnrVw, String NotifType, String Arbpl, String Equipment, String teco_status, String rel_status , String nopo_status)
        {
            this.UUID = UUID;
    ...
    SearchView.OnQueryTextListener listener = new SearchView.OnQueryTextListener()
    {
        ...
        public boolean onQueryTextChange(String query)
        {
            ...
            for (int i = 0; i < notifications_list.size(); i++)
            {
                ...
                if (notif_id.contains(query) || short_text.contains(query) || plant.contains(query) || Equipment.contains(query))
                {
                    Notif_List_Object blo = new Notif_List_Object(notifications_list.get(i).getUUID().toString(), notifications_list.get(i).getnotif_id().toString(), notifications_list.get(i).getshort_text().toString(), notifications_list.get(i).getpriority_id().toString(), notifications_list.get(i).getpriority_text().toString(), notifications_list.get(i).getstartdate().toString(), notifications_list.get(i).getstatus().toString(), notifications_list.get(i).getdocs_status().toString(), notifications_list.get(i).getstartdate_format().toString(), notifications_list.get(i).getplant().toString(), notifications_list.get(i).getStartdate_time().toString(), notifications_list.get(i).getParnrVw().toString(), notifications_list.get(i).getNotifType().toString(), notifications_list.get(i).getArbpl().toString(), notifications_list.get(i).getEquipment().toString(), notifications_list.get(i).getTeco_status().toString(), notifications_list.get(i).getRel_status().toString(), notifications_list.get(i).getNopo_status().toString());
            ...
            if(filteredList.size() > 0)
            {
                RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(Notifications_List_Activity.this);
                list_recycleview.setLayoutManager(layoutManager);
                notif_adapter = new Notif_Adapter(Notifications_List_Activity.this, filteredList);
                list_recycleview.setAdapter(notif_adapter);
    ...
    public class Notif_Adapter extends RecyclerView.Adapter<Notif_Adapter.MyViewHolder>
    {
        ...
        {
            public TextView teco_auth_textview, rel_auth_textview, nopo_auth_textview, ParnrVw_textview, uuid_textview, plant_textview, id_textview, description_textview, date_time_textview, status_type_textview, priority_textview;
        ...
        {
            View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.notifications_list_data, parent, false);
        ...
        public void onBindViewHolder(final MyViewHolder holder, int position)
        {
            ...
            if(holder.priority_textview.getText().toString().contains("Critical"))
            {
                ...
                holder.priority_textview.setBackground(getResources().getDrawable(R.color.footer_color));
            }
            ...
            {
                holder.priority_textview.setVisibility(View.VISIBLE);
                holder.priority_textview.setBackground(getResources().getDrawable(R.color.dark_grey1));
            }
            ...
            {
                holder.priority_textview.setVisibility(View.VISIBLE);
                holder.priority_textview.setBackground(getResources().getDrawable(R.color.dark_grey2));
            }
            else
            {
           ...
           if (olo.getdocs_status().equalsIgnoreCase("X"))
            ...
            {
                holder.status_type_textview.setBackground(getResources().getDrawable(R.drawable.yellow_circle));
                holder.status_type_textview.setTextColor(getResources().getColor(R.color.light_grey2));
            ...
            else
            {
                ...
                if(holder.status_type_textview.getText().toString().equalsIgnoreCase("OSNO"))
                {
                    holder.status_type_textview.setBackground(getResources().getDrawable(R.drawable.yellow_circle));
                    holder.status_type_textview.setTextColor(getResources().getColor(R.color.light_grey2));
                    ...
                    if(holder.teco_auth_textview.getText().toString().equalsIgnoreCase("X"))
                    {
                        holder.teco_layout.setVisibility(View.VISIBLE);
                    }
                    else
                    ...
                    if(holder.rel_auth_textview.getText().toString().equalsIgnoreCase("X"))
                    {
                        holder.release_layout.setVisibility(View.VISIBLE);
                    }
                    else
                    ...
                    if(holder.nopo_auth_textview.getText().toString().equalsIgnoreCase("X"))
                    {
                        holder.postpone_layout.setVisibility(View.VISIBLE);
                    }
                    else
                ...
                else if(holder.status_type_textview.getText().toString().equalsIgnoreCase("NOPR"))
                {
                    holder.status_type_textview.setBackground(getResources().getDrawable(R.drawable.blue_circle));
                ...
                else if(holder.status_type_textview.getText().toString().equalsIgnoreCase("NOCO"))
                {
                    holder.status_type_textview.setBackground(getResources().getDrawable(R.drawable.green_circle));
                    holder.status_type_textview.setTextColor(getResources().getColor(R.color.white));
                    holder.teco_layout.setVisibility(View.GONE);
                    holder.release_layout.setVisibility(View.GONE);
                    holder.postpone_layout.setVisibility(View.GONE);
                }
                else if(holder.status_type_textview.getText().toString().equalsIgnoreCase("NOPO"))
                {
                    holder.status_type_textview.setBackground(getResources().getDrawable(R.drawable.orange_circle));
                    holder.status_type_textview.setTextColor(getResources().getColor(R.color.white));
                    holder.teco_layout.setVisibility(View.VISIBLE);
                    holder.release_layout.setVisibility(View.VISIBLE);
                    holder.postpone_layout.setVisibility(View.GONE);
            ...
            holder.status_imageview.setOnClickListener(new View.OnClickListener()
            {
                ...
                {
                    Intent status_intent = new Intent(Notifications_List_Activity.this,Notifications_Status_Display_Activity.class);
                    status_intent.putExtra("notification_id",holder.id_textview.getText().toString());
            ...
            holder.teco_layout.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    if (isInternetPresent)
                    {
                        ...
                        description_textview.setText("Do you want to complete the selected Notification "+notif_number+"?");
                    ...
                    else
                    {
                        ...
                        try
                        {
                            Cursor cursor = App_db.rawQuery("select * from DUE_NOTIFICATIONS_EtNotifItems where Qmnum = ?",new String[]{notif_number});
                            if(cursor!=null && cursor.getCount()> 0)
                            {
                        ...
                        if(object_damage_status.equalsIgnoreCase("true"))
                        {
                            ...
                            try
                            {
                                Cursor cursor = App_db.rawQuery("select * from DUE_NOTIFICATION_NotifHeader where Qmnum = ?",new String[]{notif_number});
                                if(cursor!=null && cursor.getCount()> 0)
                                {
                                    String mal_date = cursor.getString(10);
                                    String mal_time = cursor.getString(12);
                                    if ((mal_date != null && !mal_date.equals("")) && (mal_time != null && !mal_time.equals("")))
                                    {
                            ...
                            if(mal_dat_tim_status.equalsIgnoreCase("true"))
                            {
                                ...
                                description_textview.setText("No Internet Connectivity. Do you want to proceed Notification Complete with offline ?");
                                confirm.setText("Yes");
                                cancel.setText("No");
                                decision_dialog.show();
                                confirm.setOnClickListener(new View.OnClickListener()
                            ...
                            {
                                error_dialog.show_error_dialog(Notifications_List_Activity.this,"Malfunction End Date/Time is Mandatory");
                            }
                        }
                        else
                        {
                            error_dialog.show_error_dialog(Notifications_List_Activity.this,"Object/Damage Code is Mandatory");
                        }
                    }
                }
            });
            ...
            holder.postpone_layout.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    if (isInternetPresent)
                    {
                        ...
                        Button confirm = (Button)decision_dialog.findViewById(R.id.yes_button);
                        Button cancel = (Button)decision_dialog.findViewById(R.id.no_button);
                        description_textview.setText("Do you want to postpone the selected Notification "+notif_number+"?");
                        decision_dialog.show();
                        cancel.setOnClickListener(new View.OnClickListener()
                        {
                            @Override
                    ...
                    else
                    {
                        ...
                        Button cancel = (Button)decision_dialog.findViewById(R.id.no_button);
                        Button connect_button =(Button) decision_dialog.findViewById(R.id.connect_button);
                        description_textview.setText("No Internet Connectivity. Do you want to proceed Notification Postpone with offline ?");
                        confirm.setText("Yes");
                        cancel.setText("No");
                        decision_dialog.show();
                        confirm.setOnClickListener(new View.OnClickListener()
            ...
            holder.data_layout.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    new Get_Notification_Data().execute(holder.id_textview.getText().toString(),holder.uuid_textview.getText().toString());
                }
            });
            /*When Particular Notification is clicked*/
    ...
    public void onClick(View v)
    {
        if (v == create_fab_button)
        {
            ...
            Intent intent = new Intent(Notifications_List_Activity.this, Notifications_Create_Activity.class);
            startActivity(intent);
        }
        ...
        else if(v == sort_fab_button)
        {
            ...
            if(notifications_list.size() > 0)
            {
                final Dialog dialog = new Dialog(Notifications_List_Activity.this,R.style.AppThemeDialog_Dark);
                ...
                final RadioButton criticaltoLow = (RadioButton) dialog.findViewById(R.id.criticaltoLow);
                final RadioButton lowtoCritical = (RadioButton) dialog.findViewById(R.id.lowtoCritical);
            ...
            {
                error_dialog.show_error_dialog(Notifications_List_Activity.this,"No Notifications Found for sorting");
            }
        }
        else if(v == scan_fab_button)
        {
            scan_clicked_equip = "";
            floatingActionMenu.close(true);
            if (ContextCompat.checkSelfPermission(Notifications_List_Activity.this, Manifest.permission.CAMERA)!= PackageManager.PERMISSION_GRANTED)
            {
                ActivityCompat.requestPermissions(Notifications_List_Activity.this,new String[]{Manifest.permission.CAMERA}, ZXING_CAMERA_PERMISSION);
            }
            else
            {
                Intent intent = new Intent(Notifications_List_Activity.this, Barcode_Scanner_Activity.class);
        ...
        else if(v == filter_fab_button)
        {
                ...
                final CheckBox attachments_checkbox = (CheckBox)dialog.findViewById(R.id.attachments_checkbox);
                final CheckBox pers_resp_checkbox = (CheckBox)dialog.findViewById(R.id.pers_resp_checkbox);
                ...
                filt_notif_type_button.setOnClickListener(new View.OnClickListener()
                {
                    ...
                    public void onClick(View v)
                    {
                        Intent notification_type_intent = new Intent(Notifications_List_Activity.this,Notifications_Type_Select_Activity.class);
                        notification_type_intent.putExtra("request_id", Integer.toString(fil_notif_type));
                        notification_type_intent.putExtra("filt_notification_ids", filt_notification_ids);
                ...
                filt_priority_type_button.setOnClickListener(new View.OnClickListener()
                {
                    ...
                    public void onClick(View v)
                    {
                        Intent notification_type_intent = new Intent(Notifications_List_Activity.this,Notifications_Priority_Select_Activity.class);
                        notification_type_intent.putExtra("request_id", Integer.toString(fil_prior_type));
                ...
                filt_status_type_button.setOnClickListener(new View.OnClickListener()
                {
                    ...
                    public void onClick(View v)
                    {
                        Intent notification_type_intent = new Intent(Notifications_List_Activity.this,Notifications_Status_Select_Activity.class);
                        notification_type_intent.putExtra("request_id", Integer.toString(fil_status_type));
                ...
                filt_workcenter_type_button.setOnClickListener(new View.OnClickListener()
                {
                    ...
                    public void onClick(View v)
                    {
                        Intent notification_type_intent = new Intent(Notifications_List_Activity.this,Notifications_WorkCenter_Select_Activity.class);
                        notification_type_intent.putExtra("request_id", Integer.toString(fil_wckt_type));
                ...
                clearAll_textview.setOnClickListener(new View.OnClickListener()
                {
                    ...
                    public void onClick(View v)
                    {
                        pers_resp_status = ""; filt_notification_ids = ""; filt_priority_ids = ""; filt_status_ids = "";  filt_wckt_text = ""; filt_wckt_ids = ""; attachment_clicked_status = "";
                        dialog.dismiss();
                        per_resp = false;
                        new Get_Notifications_List_Data().execute();
                    }
                ...
                filterBt.setOnClickListener(new View.OnClickListener()
                {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        if ((filt_notification_ids != null && !filt_notification_ids.equals("")) || (filt_priority_ids != null && !filt_priority_ids.equals("")) || (filt_status_ids != null && !filt_status_ids.equals("")) || (filt_wckt_ids != null && !filt_wckt_ids.equals("")) || (attachment_clicked_status != null && !attachment_clicked_status.equals("")) || (pers_resp_status != null && !pers_resp_status.equals("")))
                        {
                            ...
                            if(filt_selected_notif_ids.contains(","))
                            {
                                ...
                                filt_selected_notif_ids = filt_selected_notif_ids.substring(0, filt_selected_notif_ids.length()-1);
                            }
                            else
                            {
                                ...
                                try
                                {
                                    Cursor cursor = App_db.rawQuery("select * from GET_NOTIFICATION_TYPES", null);
                                    if (cursor != null && cursor.getCount() > 0) {
                                        if (cursor.moveToFirst())
                                        {
                                            do
                            ...
                            if(filt_selected_prior_ids.contains(","))
                            {
                                ...
                                filt_selected_prior_ids = filt_selected_prior_ids.substring(0, filt_selected_prior_ids.length()-1);
                            }
                            else
                            {
                                StringBuffer filter_sb = new StringBuffer();
                                try
                                {
                                    Cursor cursor = App_db.rawQuery("select * from GET_NOTIFICATION_PRIORITY", null);
                                    if (cursor != null && cursor.getCount() > 0) {
                                        if (cursor.moveToFirst())
                                        {
                                            do
                            ...
                            if(filt_selected_status_ids.contains(","))
                            {
                                ...
                                filt_selected_status_ids = filt_selected_status_ids.substring(0, filt_selected_status_ids.length()-1);
                            }
                            else
                            {
                                StringBuffer filter_sb = new StringBuffer();
                            ...
                            if(filt_selected_wckt_ids.contains(","))
                            {
                                ...
                                filt_selected_wckt_ids = filt_selected_wckt_ids.substring(0, filt_selected_wckt_ids.length()-1);
                            }
                            else
                            {
                                StringBuffer filter_sb = new StringBuffer();
                                try
                                {
                                    Cursor cursor = App_db.rawQuery("select * from GET_WKCTR", null);
                                    if (cursor != null && cursor.getCount() > 0) {
                                        if (cursor.moveToFirst())
                                        {
                                            do
                            ...
                            else
                            {
                                ...
                                try
                                {
                                    Cursor cursor = App_db.rawQuery("select * from GET_EtPernr", null);
                                    if (cursor != null && cursor.getCount() > 0)
                                    {
                                        if (cursor.moveToFirst())
                                        {
                                            do
                                            {
                                                filt_selected_persresp_ids.append(cursor.getString(3));
                            ...
                            CollectionUtils.filter(notifications_list, new Predicate()
                            {
                                ...
                                public boolean evaluate(Object o)
                                {
                                    return ((Notif_List_Object) o).getNotifType().matches(filt_selected_notif_ids) && ((Notif_List_Object) o).getpriority_id().matches(filt_selected_prior_ids) && ((Notif_List_Object) o).getstatus().matches(filt_selected_status_ids) && ((Notif_List_Object) o).getArbpl().matches(filt_selected_wckt_ids) && ((Notif_List_Object) o).getdocs_status().matches(attachment_clicked_status) && ((Notif_List_Object) o).getParnrVw().matches(filt_selected_persresp_ids.toString());
                                }
                            });
                            if(notifications_list.size() > 0)
                            {
                        ...
                        {
                            error_dialog.show_error_dialog(Notifications_List_Activity.this,"Please Select Atleast One Filter");
                        }
                    }
                });
        }
    ...
    public void onRequestPermissionsResult(int requestCode, String permissions[], int[] grantResults)
    {
        switch (requestCode)
        {
            case ZXING_CAMERA_PERMISSION:
                ...
                {
                    Toast.makeText(Notifications_List_Activity.this, "Please grant camera permission to use the Scanner", Toast.LENGTH_LONG).show();
                }
                return;
        }
    }
    ...
    public class Get_Notifications_Refresh_Data extends AsyncTask<Void, Integer, Void>
    {
        ...
        {
            super.onPreExecute();
            progressDialog.show_progress_dialog(Notifications_List_Activity.this,getResources().getString(R.string.refreshing_notifications));
        }
        @Override
        protected Void doInBackground(Void... params)
        {
            try
            {
                DNOT_Status = Notifications.Get_DNOT_Data(Notifications_List_Activity.this,"REFR");
            }
            catch (Exception e)
            {
            }
    ...
    private class Post_Notification_Release extends AsyncTask<String, Integer, Void>
    {
        ...
        {
            super.onPreExecute();
            progressDialog.show_progress_dialog(Notifications_List_Activity.this,getResources().getString(R.string.notif_release_inprogress));
        }
        @Override
        protected Void doInBackground(String... params)
        {
            try
            {
                ...
                notif_release_status = Notification_Release.Get_Notif_Release_Data(Notifications_List_Activity.this,params[0]);
            }
            catch (Exception e)
            {
            }
        ...
        protected void onPostExecute(Void result)
        {
            ...
            if (notif_release_status != null && !notif_release_status.equals(""))
            {
                ...
                {
                    progressDialog.dismiss_progress_dialog();
                    error_dialog.show_error_dialog(Notifications_List_Activity.this,"Notification "+notification_id+" is already released");
                }
                else if(notif_release_status.get("response_status").startsWith("E"))
                {
                    progressDialog.dismiss_progress_dialog();
                    error_dialog.show_error_dialog(Notifications_List_Activity.this,notif_release_status.get("response_status").substring(1));
                }
                else
                {
                    progressDialog.dismiss_progress_dialog();
                    error_dialog.show_error_dialog(Notifications_List_Activity.this,"Unable to process Notification Release. Please try again.");
                }
            }
            else
            {
    ...
    private class Get_DORD_Data extends AsyncTask<String, Integer, Void>
    {
        ...
        protected Void doInBackground(String... params)
        {
            try
            {
                ...
                DORD_Status = Orders.Get_DORD_Data(Notifications_List_Activity.this,"Single_Ord",aufnr);
            }
            catch (Exception e)
            {
            }
        ...
        protected void onPostExecute(Void result)
        {
            super.onPostExecute(result);
            progressDialog.dismiss_progress_dialog();
            success_dialog.show_success_dialog(Notifications_List_Activity.this,"Notification "+notification_id+" is released successfully."+"\n"+"Order "+aufnr+" has been created successfully.");
            new Get_Notifications_List_Data().execute();
        }
    }
    /*Getting Order Data After Notification Release*/
    ...
    private class Post_Notification_Postpone extends AsyncTask<String, Integer, Void>
    {
        ...
        {
            super.onPreExecute();
            progressDialog.show_progress_dialog(Notifications_List_Activity.this,getResources().getString(R.string.notif_postpone_inprogress));
        }
        @Override
        protected Void doInBackground(String... params)
        {
            ...
            {
                notification_id = params[0];
                notif_postpone_status = Notification_Postpone.Get_Notif_Postpone_Data(Notifications_List_Activity.this,params[0]);
            }
            catch (Exception e)
            {
            }
        ...
        protected void onPostExecute(Void result)
        {
            ...
            if (notif_postpone_status != null && !notif_postpone_status.equals(""))
            {
                ...
                {
                    progressDialog.dismiss_progress_dialog();
                    success_dialog.show_success_dialog(Notifications_List_Activity.this,"Notification "+notification_id+" is postponed successfully");
                    new Get_Notifications_List_Data().execute();
                }
                else if(notif_postpone_status.contains("already postponed"))
                {
                    progressDialog.dismiss_progress_dialog();
                    error_dialog.show_error_dialog(Notifications_List_Activity.this,"Notification "+notification_id+" is already postponed.");
                }
                else if(notif_postpone_status.startsWith("E"))
                {
                    progressDialog.dismiss_progress_dialog();
                    error_dialog.show_error_dialog(Notifications_List_Activity.this,notif_postpone_status.substring(0));
                }
                else
                {
                    progressDialog.dismiss_progress_dialog();
                    error_dialog.show_error_dialog(Notifications_List_Activity.this,"Unable to process Notification Postpone. Please try again.");
                }
            }
            else
            {
    ...
    private class Get_Token extends AsyncTask<String, Integer, Void>
    {
        ...
        {
            super.onPreExecute();
            progressDialog.show_progress_dialog(Notifications_List_Activity.this,getResources().getString(R.string.notif_complete_inprogress));
        }
        @Override
        protected Void doInBackground(String... params)
        {
        ...
        protected void onPostExecute(Void result)
        {
            ...
            {
                progressDialog.dismiss_progress_dialog();
                error_dialog.show_error_dialog(Notifications_List_Activity.this,"Unable to process Notification Complete. Please try again");
            }
        }
    }
    ...
    private class Post_Notification_Complete extends AsyncTask<String, Integer, Void>
    {
        ...
        protected Void doInBackground(String... params)
        {
            ...
            {
                notification_id = params[0];
                notif_complete_status = Notification_Complete.Get_NOCO_Data(Notifications_List_Activity.this,params[0]);
            }
            catch (Exception e)
            {
            }
        ...
        protected void onPostExecute(Void result)
        {
            ...
            if (notif_complete_status != null && !notif_complete_status.equals(""))
            {
                if(notif_complete_status.equalsIgnoreCase("success"))
                {
                    ...
                    cv.put("Xstatus", "NOCO");
                    cv.put("STATUS", "NOCO");
                    App_db.update("DUE_NOTIFICATION_NotifHeader", cv, "Qmnum=?", new String[]{notification_id});
                    progressDialog.dismiss_progress_dialog();
                    success_dialog.show_success_dialog(Notifications_List_Activity.this,"Notification "+notification_id+" is completed succesfully");
                    new Get_Notifications_List_Data().execute();
                }
                else if(notif_complete_status.startsWith("E"))
                {
                    progressDialog.dismiss_progress_dialog();
                    error_dialog.show_error_dialog(Notifications_List_Activity.this,notif_complete_status.substring(1));
                }
                else
                {
                    progressDialog.dismiss_progress_dialog();
                    error_dialog.show_error_dialog(Notifications_List_Activity.this,notif_complete_status);
                }
            }
            else
            {
    ...
    private class Get_Notification_Data extends AsyncTask<String, Integer, Void>
    {
        ...
        {
            super.onPreExecute();
            progressDialog.show_progress_dialog(Notifications_List_Activity.this,getResources().getString(R.string.fetching_notifcation));
        }
        @Override
        protected Void doInBackground(String... params)
        {
            try
            {
                ...
                try
                {
                    ...
                    Tasks_cursor = App_db.rawQuery("select * from DUE_NOTIFICATION_EtNotifTasks where UUID = ?", new String[]{notification_uuid});
        ...
        protected void onPostExecute(Void result)
        {
            ...
            if (nhp != null)
            {
                Intent ordrIntent = new Intent(Notifications_List_Activity.this, Notifications_Change_Activity.class);
