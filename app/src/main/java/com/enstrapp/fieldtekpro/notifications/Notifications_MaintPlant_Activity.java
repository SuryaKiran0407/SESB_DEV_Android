...
public class Notifications_MaintPlant_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            filt_notification_ids = extras.getString("filt_maintplant_ids");
    ...
    private class Get_Notification_Types extends AsyncTask<Void, Integer, Void> {
        ...
        protected void onPreExecute() {
            ...
            custom_progress_dialog
                    .show_progress_dialog(Notifications_MaintPlant_Activity.this,
        ...
        protected Void doInBackground(Void... params) {
            try {
                Cursor cursor = FieldTekPro_db.rawQuery("select * from GET_PLANTS",
                        null);
                        ...
                        do {
                            ...
                            if (filt_notification_array.contains(notf_id)) {
                                Notification_Type_Object nto =
                                        new Notification_Type_Object(cursor.getString(1),
        ...
        protected void onPostExecute(Void result) {
            ...
            if (notification_type_list.size() > 0) {
                title_textview.setText(getResources().getString(R.string.maintenance_plant) + " (" + notification_type_list.size() + ")");
                adapter =
                        new NOTIFICATION_TYPE_ADAPTER(Notifications_MaintPlant_Activity.this,
                                notification_type_list);
                list_recycleview.setHasFixedSize(true);
                RecyclerView.LayoutManager layoutManager =
                        new LinearLayoutManager(Notifications_MaintPlant_Activity.this);
                ...
                title_textview.setText(getResources().getString(R.string.maintenance_plant) + " (0)");
                ...
                if (id.contains(query) || value.contains(query)) {
                    Notification_Type_Object nto =
                            new Notification_Type_Object(notification_type_list.get(i).getNotification_id(),
                                    ...
                                    notification_type_list.get(i).isChecked_status());
    ...
    public void onClick(View v) {
        if (v == back_imageview) {
            Notifications_MaintPlant_Activity.this.finish();
            ...
            if (selected_array.size() > 0) {
                ...
                intent.putExtra("maintplant_ids", filter_sb.toString());
                setResult(request_id, intent);
                Notifications_MaintPlant_Activity.this.finish();
            } else {
                error_dialog.show_error_dialog(Notifications_MaintPlant_Activity.this,
                        "Please Select Atleast One Maintenance Plant.");
            }
        }
    }
}
