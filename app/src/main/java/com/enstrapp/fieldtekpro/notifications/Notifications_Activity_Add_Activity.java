...
public class Notifications_Activity_Add_Activity extends FragmentActivity implements View.OnClickListener
{
    ...
    LinearLayout end_datetime_layout, start_datetime_layout, code_layout, codegroup_layout, itemkey_layout;
    EditText end_datetime_edittext, start_datetime_edittext, text_edittext, code_edittext, codegroup_edittext, event_edittext, objectpart_edittext, itemkey_edittext;
    String activity_itemkey = "", status = "I", position = "", enddate_time_formatted ="", enddate_time = "", enddate_date_formated ="", enddate_date = "", stdate_time_formatted ="", stdate_time ="", stdate_date_formated = "", stdate_date = "", code_id = "", code_text = "", codegroup_text = "", codegroup_id = "", cause_text = "", cause_itemkey = "", functionlocation_id = "", equipment_id = "", catelog_profile = "";
    int request_id = 0;
    private SQLiteDatabase FieldTekPro_db;
    private static String DATABASE_NAME = "";
    Error_Dialog error_dialog = new Error_Dialog();
    int activity_custom_info = 6, itemkey_type = 1, codegroup_type = 2, code_type = 3, start_datetime = 4, end_datetime = 5;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (extras != null)
        {
            ...
            causecode_array_list = (ArrayList<HashMap<String, String>>) getIntent().getSerializableExtra("causecode_array_list");
            ...
            if (position != null && !position.equals(""))
            {
                ...
                selected_activity_custom_info_arraylist = (ArrayList<HashMap<String, String>>)getIntent().getSerializableExtra("selected_activity_custom_info_arraylist");
            }
        }
    ...
    public void onClick(View v)
    {
        ...
        {
            Intent custominfo_intent = new Intent(Notifications_Activity_Add_Activity.this, CustomInfo_Activity.class);
            custominfo_intent.putExtra("Zdoctype","Q");
            custominfo_intent.putExtra("ZdoctypeItem","QA");
            custominfo_intent.putExtra("custom_info_arraylist",selected_activity_custom_info_arraylist);
            ...
            if (cause_itemkey != null && !cause_itemkey.equals(""))
            {
                if (codegroup_id != null && !codegroup_id.equals(""))
                {
                    if (code_id != null && !code_id.equals(""))
                    {
                        ...
                        intent.putExtra("objectpartcode_id",objectpart_edittext.getText().toString());
                        ...
                        intent.putExtra("selected_activity_custom_info_arraylist",selected_activity_custom_info_arraylist);
                        setResult(request_id,intent);
                        Notifications_Activity_Add_Activity.this.finish();
                    }
                    else
                    {
                        error_dialog.show_error_dialog(Notifications_Activity_Add_Activity.this, "Please select "+getResources().getString(R.string.code));
                    }
                }
                else
                {
                    error_dialog.show_error_dialog(Notifications_Activity_Add_Activity.this, "Please select "+getResources().getString(R.string.code_group));
                }
            }
            else
            {
                error_dialog.show_error_dialog(Notifications_Activity_Add_Activity.this, "Please select "+getResources().getString(R.string.item_key));
            }
        }
        ...
        {
            Intent itemkey_intent = new Intent(Notifications_Activity_Add_Activity.this,Notifications_Activity_ItemKey_Activity.class);
        ...
        {
            Intent objectpart_intent = new Intent(Notifications_Activity_Add_Activity.this,Notifications_Activity_Codegroup_Activity.class);
        ...
        else if (v == code_layout)
        {
            if (codegroup_id != null && !codegroup_id.equals(""))
            {
                Intent objectpart_intent = new Intent(Notifications_Activity_Add_Activity.this,Notifications_Activity_Code_Activity.class);
        ...
        {
            Intent intent = new Intent(Notifications_Activity_Add_Activity.this, DateTimePickerDialog.class);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        if (data != null && !data.equals(""))
        {
            ...
            {
                selected_activity_custom_info_arraylist = (ArrayList<HashMap<String, String>>) data.getSerializableExtra("selected_custom_info_arraylist");
            }
        }
    }
