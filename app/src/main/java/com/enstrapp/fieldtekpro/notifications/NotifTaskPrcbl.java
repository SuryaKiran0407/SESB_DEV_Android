...
public class NotifTaskPrcbl implements Parcelable
{
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.taskGrp);
        dest.writeString(this.taskgrptext);
        dest.writeString(this.taskCod);
        dest.writeString(this.taskcodetext);
        dest.writeString(this.taskShtxt);
        dest.writeString(this.pster);
        dest.writeString(this.peter);
        dest.writeString(this.pstur);
        dest.writeString(this.petur);
        dest.writeString(this.parvw);
        dest.writeString(this.parnr);
        dest.writeString(this.erlnam);
        dest.writeString(this.erldat);
        dest.writeString(this.erlzeit);
        dest.writeString(this.release);
        dest.writeString(this.complete);
        dest.writeString(this.success);
        dest.writeString(this.userStatus);
        dest.writeString(this.sysStatus);
        dest.writeString(this.smsttxt);
        dest.writeString(this.smastxt);
    ...
    public NotifTaskPrcbl() {
    }

    protected NotifTaskPrcbl(Parcel in) {
        ...
        this.taskGrp = in.readString();
        this.taskgrptext = in.readString();
        this.taskCod = in.readString();
        this.taskcodetext = in.readString();
        this.taskShtxt = in.readString();
        this.pster = in.readString();
        this.peter = in.readString();
        this.pstur = in.readString();
        this.petur = in.readString();
        this.parvw = in.readString();
        this.parnr = in.readString();
        this.erlnam = in.readString();
        this.erldat = in.readString();
        this.erlzeit = in.readString();
        this.release = in.readString();
        this.complete = in.readString();
        this.success = in.readString();
        this.userStatus = in.readString();
        this.sysStatus = in.readString();
        this.smsttxt = in.readString();
        this.smastxt = in.readString();
    ...
    public static final Creator<NotifTaskPrcbl> CREATOR = new Creator<NotifTaskPrcbl>() {
        @Override
        public NotifTaskPrcbl createFromParcel(Parcel source) {
            return new NotifTaskPrcbl(source);
        }

        @Override
        public NotifTaskPrcbl[] newArray(int size) {
            return new NotifTaskPrcbl[size];
        }
    };
}
